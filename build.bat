...
:installdeps
	...
	call :download wireguard-tools.zip https://git.zx2c4.com/wireguard-tools/snapshot/wireguard-tools-1.0.20191226.zip 5145d213b1b8e3cbfa77d75fd912b20f2f35641ce65fa98969f8332e9631f17a "--exclude wg-quick --strip-components 1" || goto :error
